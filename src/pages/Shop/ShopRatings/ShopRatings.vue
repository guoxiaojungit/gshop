    ...
    <div class="ratings" ref="ratings">
        <div class="ratings-content">
            ...
            <div class="rating-wrapper">
                <ul>
                    <li class="rating-item" v-for="(rating,index) in fliterRatings" :key="index">
                        <div class="avatar">
                        ...
                        <div class="content">
                            ...
                            <div class="recommend">
                                <span class="iconfont" :class="rating.rateType===0 ? 'icon-dianzan' : 'icon-chaping'"></span>
        ...
        .rating-item
            ...
            .content
                ...
                .recommend
                    line-height 16px
                    font-size 0
                    .icon-dianzan, .icon-chaping, .item
                        display inline-block
                        margin 0 8px 4px 0
                        font-size 9px
                    .icon-dianzan
